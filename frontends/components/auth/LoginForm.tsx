...
import { getGoogleAuthUrl, loginWithEmail, setStoredToken, type User } from "@/lib/auth";
...
export function LoginForm({ onSuccess, initialError }: Props) {
  ...
  return (
    <div className="w-full max-w-[420px] rounded-2xl border-[1.5px] border-[#eee] bg-white p-8 shadow-sm">
      ...
      <p className="mt-1 text-[#848181]">Welcome back. Sign in to continue.</p>
